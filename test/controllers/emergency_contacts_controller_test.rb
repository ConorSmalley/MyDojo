...
class EmergencyContactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emergency_contact" do
    assert_difference('EmergencyContact.count') do
      post emergency_contacts_url, params: { emergency_contact: { name: @emergency_contact.name, number: @emergency_contact.number, relationship: @emergency_contact.relationship } }
    end
  ...
  test "should update emergency_contact" do
    patch emergency_contact_url(@emergency_contact), params: { emergency_contact: { name: @emergency_contact.name, number: @emergency_contact.number, relationship: @emergency_contact.relationship } }
