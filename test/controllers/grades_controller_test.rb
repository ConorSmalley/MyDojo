...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { colour: @grade.colour, name: @grade.name, tag: @grade.tag } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { colour: @grade.colour, name: @grade.name, tag: @grade.tag } }
