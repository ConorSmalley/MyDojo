class EmergencyContactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @emergency_contact.save
        format.html { redirect_to student_path(@emergency_contact.student_id), notice: "Emergency contact was successfully created." }
  ...
  def update
    respond_to do |format|
      if @emergency_contact.update(emergency_contact_params)
        format.html { redirect_to student_path(@emergency_contact.student_id), notice: "Emergency contact was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to student_path(@emergency_contact.student_id), notice: "Emergency contact was successfully destroyed." }
  ...
  private
    ...
    def emergency_contact_params
      params.require(:emergency_contact).permit(:name, :relationship, :number, :student_id)
    end
end
